...
module.exports = {
      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          if (!isPrems && plugin.limit && global.DATABASE._data.users[m.sender].limit < plugin.limit * 1) {
            this.reply(m.chat, `Your ticket is sold out, please buy it through *${usedPrefix}buy*`, m)
        ...
        if (chat.welcome) {
          ...
          for (let user of participants) {
            ...
            try {
              ...
              let wel = `https://www6.flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=sketch-name&doScale=true&scaleWidth=800&scaleHeight=500&fontsize=100&fillTextType=1&fillTextPattern=Warning!&text=Hai Welcome`
              let lea = `https://www6.flamingtext.com/net-fu/proxy_form.cgi?&imageoutput=true&script=sketch-name&doScale=true&scaleWidth=800&scaleHeight=500&fontsize=100&fillTextType=1&fillTextPattern=Warning!&text=Dah Goodbye`
  ...
  async delete(m) {
    ...
    ── 「 ANTI DELETE 」 ──
Detected @${m.participant.split`@`[0]} Have Deleted This Message
...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    unreg: 'NOT REGISTERED \nPlease Register First Before Using Quantum Bot. How to register simply by using the command *#register name.age*\nExample #register Humans.18\nNote:\nPlease Save Your Serial Number So You Can Unregister Database Bot'
  }[type]
